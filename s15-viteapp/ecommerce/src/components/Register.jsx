...
export default function Register() {
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh', backgroundColor: '#f4f4f9' }}>
      <div style={{ background: '#fff', padding: '20px 25px', borderRadius: '10px', boxShadow: '0 4px 6px rgba(37, 9, 221, 0.1)', width: '300px' }}>
